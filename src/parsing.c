...
lval *builtin(lenv *e, lval *a, char *func) {
  ...
  if(strcmp("+", func) == 0) { return builtin_add(e, a); }
  if(strcmp("-", func) == 0) { return builtin_sub(e, a); }
  if(strcmp("*", func) == 0) { return builtin_mul(e, a); }
  if(strcmp("/", func) == 0) { return builtin_div(e, a); }
